...
export default function Home() {
  ...
  return (
    <main 
      data-tone={tone} 
      className="theme-transition min-h-screen bg-zinc-950 text-zinc-100 selection:bg-purple-500/30 relative"
    >
      {/* Background Decorative Grid and Glow Blooms Wrapper */}
